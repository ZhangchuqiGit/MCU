...
//.c 文件无需任何修改
// PA4-IRQ --- SPI1_NSS(6)
#define NRF24L01_GPIOx_IRQ                  GPIOA
#define NRF24L01_IRQ_Pin                    GPIO_Pin_4
#define NRF24L01_IRQ_IN                     PAin(4)                //IRQ主机数据输入
//PB0-CE  PB1-CSN 
...
#define NRF24L01_SPI_SELECT                 1                       //1:SPI1  2:SPI2
...
#define PIN_LV           0   //0~127   2400+(0~127 )
//nrf 节点选择
