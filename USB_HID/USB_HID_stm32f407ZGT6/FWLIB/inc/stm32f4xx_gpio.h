...
typedef enum
{
	GPIO_Mode_IN   = 0x00, /*!< GPIO Input Mode 输入功能 */
	GPIO_Mode_OUT  = 0x01, /*!< GPIO Output Mode 输出功能 */
	GPIO_Mode_AF   = 0x02, /*!< GPIO Alternate function Mode 复用功能 */
