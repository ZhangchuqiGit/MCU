...
////////////////////////////////////////////////////////////////////////////////
const u16 POINT_COLOR_TBL[CT_MAX_TOUCH]={RED,GREEN,BLUE,BROWN,GRED};   //5个触控点的颜色												 
////////////////////////////////////////////////////////////////////////////////
void rtp_test(void)//电阻触摸屏测试函数
{
	tp_dev.scan(0); //扫描触摸屏.      0,屏幕扫描;1,物理坐标;	 		 
	if(tp_dev.sta&TP_PRES_DOWN)//触摸屏 被 按下
	{	
//		do_touch_function();
	}
...
/////////////////////////////////////////////////
void LCD_touch_user(void)
{	 		    	 
//	if(tp_dev.touchtype!=0XFF)LCD_ShowString(60,130,200,16,16,"电阻屏");//电阻屏才显示
