...
short ds18b20_value=0;//2788 温度值 27.88C
...
u8 DS18B20_Init(void)
{
 	...
 	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_7;				//PORTG.11 推挽输出
...
//从ds18b20得到温度值
//精度：0.1C
//返回值：温度值 （-5500~12500）（-55.00~125.00） , ds18b20_value = 2788 温度值 27.88 C
...
//	tem=(float)tem*0.0625*100+0.5;//转换     
	tem=(float)tem*0.0625*10+0.5;//转换     
//temp=tp*0.0625*100+0.5;	
//留 两个小数点 就*100，+0.5是四舍五入，因为C语言浮点数转换为整型的时候把小数点
