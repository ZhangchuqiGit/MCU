...
//	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN_FLOATING;//浮空输入
	...
	void USART1_IRQHandler(void)                	//串口1中断服务程序  --  数据包的形式接收
	{
		...
		if( USART1_RX_BUF[USART1_RX_num-1] == 0x4D | USART1_RX_BUF[USART1_RX_num-1] == 0x4C |  //头 
			USART1_RX_BUF[USART1_RX_num-1] == 0x52 | USART1_RX_BUF[USART1_RX_num-1] == 0x44 |   
			USART1_RX_BUF[USART1_RX_num-1] == 0x4D | USART1_RX_BUF[USART1_RX_num-1] == 0x4C |
			USART1_RX_BUF[USART1_RX_num-1] == '+' ) 
			USART1_RX_head = USART1_RX_num-1;   //头   
		
		if( (USART1_RX_BUF[USART1_RX_head] == 0x4D | USART1_RX_BUF[USART1_RX_head] == 0x4C |  //头 
			 USART1_RX_BUF[USART1_RX_head] == 0x52 | USART1_RX_BUF[USART1_RX_head] == 0x44 |   
			 USART1_RX_BUF[USART1_RX_head] == 0x4D | USART1_RX_BUF[USART1_RX_head] == 0x4C | 
			 USART1_RX_BUF[USART1_RX_head] == '+'  ) //********** 
		&&(//************************************************************************************尾
	/*动作*/( USART1_RX_BUF[USART1_RX_num-3] == 0x6e && USART1_RX_BUF[USART1_RX_num-2] == 0x67 ) |
	/*喇叭*/( USART1_RX_BUF[USART1_RX_num-3] == 0x6f && USART1_RX_BUF[USART1_RX_num-2] == 0x70 ) |
	/*    */( USART1_RX_BUF[USART1_RX_num-3] == 0x20 && USART1_RX_BUF[USART1_RX_num-2] == 0x30 ) |
	/*    */( USART1_RX_BUF[USART1_RX_num-3] == 0x20 && USART1_RX_BUF[USART1_RX_num-2] == 0x31 ) |
	/*云台*/( USART1_RX_BUF[USART1_RX_num-3] == 0x6e && USART1_RX_BUF[USART1_RX_num-2] == 0x67 ) |
	/*云台*/( USART1_RX_BUF[USART1_RX_num-3] == 0x69 && USART1_RX_BUF[USART1_RX_num-2] == 0x61 ) |
	/*云台*/( USART1_RX_BUF[USART1_RX_num-3] == 0x75 && USART1_RX_BUF[USART1_RX_num-2] == 0x6f ) |
	/*云台*/( USART1_RX_BUF[USART1_RX_num-3] == 0x6f && USART1_RX_BUF[USART1_RX_num-2] == 0x75 ) |
	/*云台*/( USART1_RX_BUF[USART1_RX_num-3] == 0x6e && USART1_RX_BUF[USART1_RX_num-2] == 0x67 ) |
			 USART1_RX_BUF[USART1_RX_num-2] == '-' )		 )
		{   //检测到头的情况下检测到尾   
...
//	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN_FLOATING;//浮空输入
   ...
   //USART 初始化设置    
	...
	void USART3_IRQHandler(void)                	//串口3中断服务程序  --  数据包的形式接收
	{
		...
		if(USART3_RX_BUF[USART3_RX_num-1] == '*') USART3_RX_head = USART3_RX_num-1;   //头   
		
		if( (USART3_RX_BUF[USART3_RX_head] =='*')&&(USART3_RX_BUF[USART3_RX_num-1] == '+') ) //检测到头的情况下检测到尾   
		{   
